        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4 flex-wrap gap-4">
              <h1 className="text-4xl font-bold text-slate-900">💰 Part Payment Calculator</h1>
              {displayResult && (
                <button
                  onClick={handleBackToCalculator}
                  className="bg-slate-600 hover:bg-slate-700 text-white px-6 py-2 rounded-lg transition duration-200"
                >
          ...
          {displayResult && (
            <div className="mb-6 grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white p-4 rounded-lg shadow border-l-4 border-blue-500">
                <p className="text-xs font-semibold text-slate-600 uppercase mb-1">Principal</p>
                <p className="text-2xl font-bold text-slate-900">
                  ₹{displayResult.principal.toLocaleString('en-IN')}
                </p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow border-l-4 border-green-500">
                <p className="text-xs font-semibold text-slate-600 uppercase mb-1">Interest Rate</p>
                <p className="text-2xl font-bold text-slate-900">{displayResult.interestRate}%</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow border-l-4 border-orange-500">
                <p className="text-xs font-semibold text-slate-600 uppercase mb-1">Tenure</p>
                <p className="text-2xl font-bold text-slate-900">{displayResult.tenure} months</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow border-l-4 border-purple-500">
                <p className="text-xs font-semibold text-slate-600 uppercase mb-1">Monthly EMI</p>
            ...
            <div className="mb-6 p-6 bg-red-50 border-2 border-red-300 rounded-lg">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-red-900 mb-2">Complete EMI Calculation First</h3>
                  <p className="text-red-800 mb-4">❌ Please complete the EMI calculation first before using Part Payment Calculator</p>
                  <button
                    onClick={handleBackToCalculator}
